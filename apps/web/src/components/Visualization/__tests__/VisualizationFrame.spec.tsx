...
async function createBlock(): Promise<VisualizationBlockLike> {
  ...
  return { type: 'visualization', source: { type: 'file_id', file_id: 'viz-frame-1' }, format: 'ant-chat.visualization.html.v1', title: '请求延迟', summary: '查看阶段延迟', size: bytes.byteLength, sha256: await sha256Hex(bytes) }
}
