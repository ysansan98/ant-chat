            ...
            const automation = await this.modules.automation.create({
              input: {
                ...
                permissionPolicy: {
                  ...
                  allowArbitraryCommands: permissionPolicy?.allowArbitraryCommands ?? false,
                  commandPatterns: permissionPolicy?.commandPatterns ?? [],
                  allowNetwork: permissionPolicy?.allowNetwork ?? false,
                },
