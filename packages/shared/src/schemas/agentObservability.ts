...
export const PolicyBasisSchema = z.enum([
  ...
  'command.risk.require-approval',
  'command.bottomline-block',
  'approval-rule.deny-match',
  'approval.rule-read-failed',
  ...
  'automation.command-read.allow',
  'automation.command-read.blocked',
  'automation.mcp.allow',
  'automation.mcp.blocked',
  'automation.command.allow',
  'automation.command.blocked',
  'automation.command.pattern-match',
  'automation.command.pattern-blocked',
